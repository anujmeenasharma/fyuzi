...
export const LogoLoop = memo(
  ({
    ...
    speed = 120,
    direction = 'left',
    width = '80%', // changed from '100%' to '70%'
    logoHeight = 10, // made logos smaller (was 28)
    gap = 32,
    pauseOnHover = true,
    fadeOut = false,
    fadeOutColor,
    ...
    const rootClasses = useMemo(
      () =>
        cx(
          ...
          '[--logoloop-gap:32px]',
          '[--logoloop-logoHeight:18px]', // changed from 28px to 18px
    ...
    const containerStyle = useMemo(
      () => ({
        width: toCssLength(width) ?? '70%', // changed from '100%' to '70%'
        ...cssVariables,
        ...style
      }),
          ...
          <>
            <div
              ...
              className={cx(
                ...
                'w-[clamp(64px,16%,240px)]',
                'bg-[linear-gradient(90deg,#E2E1DC_0%,rgba(226,225,220,0)_100%)]'
              )}
            />
            <div
              aria-hidden
              className={cx(
                ...
                'w-[clamp(64px,16%,240px)]',
                'bg-[linear-gradient(270deg,#E2E1DC_0%,rgba(226,225,220,0)_100%)]'
              )}
            />
          </>
        )}
