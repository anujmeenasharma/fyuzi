...
const PricingScreen = () => {
  return (
    <div className="h-screen pt-12 font-[Inter] flex flex-col justify-center items-center">
                    ...
                    <p className="mt-6 text-sm font-[inter] font-light w-2/5 text-center">
                        Search millions of creators in seconds using AI-powered
                        filters:{" "}
      ...
      hover:bg-[#E2E1DC] transition duration-300 group-hover:shadow-xl bg-[#E2E1DC]"
                            >
                                <div className="text-sm">
                                    ...
                                    <p className="text-[#4F4F4F] font-medium mt-6 mb-3.5">
                                        Ideal For
                                    </p>
                                ...
                                <div className="flex gap-3 absolute top-1/2 -translate-y-1/2">
                                    <h3 className="py-2.5 px-4 border border-[#828282] rounded-full leading-none text-sm">
                                        400 Credits
                                    </h3>
                                    <h3 className="py-2.5 px-4 border border-[#828282] rounded-full leading-none text-sm">
                                ...
                                <div className="flex justify-between items-center">
                                    <h1 className="text-[#828282] font-light font-archivo">
                                        <span className="text-3xl text-[#0D0D0D] font-bold">
                                            $49
                                        </span>
                                        /Month
                                    </h1>
      ...
      before:blur-[120px] before:opacity-100"
                            ...
                            >
                                <div className="text-sm">
                                    ...
                                    <p className="font-medium mt-6 mb-3.5">
                                        Ideal For
                                    </p>
                                ...
                                <div className="flex gap-3 absolute top-1/2 -translate-y-1/2">
                                    <h3 className="py-2.5 px-4 bg-white text-black rounded-full leading-none text-sm">
                                        1500 Credits
                                    </h3>
                                    <h3 className="py-2.5 px-4 bg-white text-black rounded-full leading-none text-sm">
      ...
      hover:bg-[#E2E1DC] transition duration-300 group-hover:shadow-xl bg-[#E2E1DC]"
                            >
                                ...
                                <div className="flex gap-3 absolute top-1/2 -translate-y-1/2">
                                    <h3 className="py-2.5 px-4 border border-[#828282] rounded-full leading-none text-sm text-nowrap">
                                        10,000+ Credits
                                    </h3>
                                    <h3 className="py-2.5 px-4 border border-[#828282] rounded-full leading-none text-sm text-nowrap">
                    ...
                    <div className="mt-6 flex gap-3 self-end items-center text-sm font-light font-[Inter] px-[2.5%]">
                      <h3>ADD-ONS</h3>
                      <p className="py-2.5 px-4 border border-[#828282] rounded-full text-[#4F4F4F]">Extra credits : <span className="text-xl font-medium leading-none">$0.15</span>/credit pay as you go</p>
                      <p className="py-2.5 px-4 border border-[#828282] rounded-full text-[#4F4F4F]">Data enrichment (Audience demographics, Engagement analysis) : Bundle at +20% Plan cost</p>
                    </div>
                </div>
  )
}
